...
public class ApplicationConfig extends WebMvcConfigurationSupport {
	...
	/*
	 * @Bean public XmlViewResolver xmlViewResolver(){ XmlViewResolver viewResolver
	 * = new XmlViewResolver(); viewResolver.setLocation(new
	 * ClassPathResource("views.xml")); viewResolver.setOrder(1); return
	 * viewResolver; }
	 */
